...
public class Vclas_TestCases extends DriverSuite {
	...
	public void Nodes_MoveButton()throws InterruptedException{
		...
		reportStep("Move button mouse over to verify the message in swedish: Använd det här alternativet för att aktivera eller avaktivera Flytta-knappen.", "pass", true);
